    ...
    >
      ...
      <div className="Second mb-6">
        ...
        >
          ...
          <div
            className={`xs:w-screen md:w-[400px] sm:w-[400px] relative h-[100%] xl:ml-28 lg:ml-20 md:ml-16 bg-slate-100 backdrop-blur-md bg-opacity-70 p-12 text-xl sm:ml-0 sm:text-base md:text-lg lg:text-xl z-20 ${
              currentLang === "ar" ? "text-right" : "text-left"
            }`}
          >
      ...
      <div
        className={`flex justify-center items-center text-center mt-[180px] w-full h-auto md:h-[250px] px-4 md:px-0 `}
      >
