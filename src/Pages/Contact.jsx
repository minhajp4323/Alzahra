...
function Contact() {
  ...
  return (
    <div className="flex flex-col justify-center items-center h- ">
      <div className="max-w-[1520px] flex flex-col items-center justify-center w-full ">
        ...
        >
          ...
          >
            ...
            <div className="absolute bg-[#171717] md:bg-opacity-70 xs:bg-opacity-75 md:p-[59px] xs:p-[20px] lg:ml-[10%] md:ml-[35px] xs:ml-0 shadow-md xs:h-[72.8%] sm:h-[72.8%]  md:h-[72.1%] lg:h-[72.2%] md:w-[420px] xs:w-screen text-center backdrop-blur-[10px] flex items-center justify-center bottom-0 left-0">
              <p
