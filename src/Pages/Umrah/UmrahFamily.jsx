...
function Umrah_Family() {
  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col text-center items-center  mb-20 md:mb-28 lg:mb-[90px] px-4" dir={currentLang === "ar" ? "rtl" : "ltr"}>
        <div className="mb-16 lg:mb-[60px] -ml-2 md:-ml-4 lg:-ml-8">
          ...
          >
            ...
            >
              <h1 className="m-0">
                <Trans ns="UmrahFamily" i18nKey="Family" />
              </h1>
              <h1 className="m-0 -mt-2 md:-mt-5 lg:-mt-10">
                {" "}
                <Trans ns="UmrahFamily" i18nKey="Package" />
              </h1>
            </div>
          </div>
        </div>
        ...
        <div className="text-[16px] md:text-[20px] lg:text-[24px] w-full md:w-[600px] lg:w-[859px] text-[#5D5D5D] mb-[100px]">
          <Trans ns="UmrahFamily" i18nKey="description" />
        </div>
        <div className="">
          <p className="text-[30px] text-[#7D7D7D] font-bold">
            <Trans ns="UmrahFamily" i18nKey="Included" />
          </p>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="visaDes" />
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="roundTripDes" />
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="airportDes" />
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="guideDes" />
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="personalDes" />
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className={`col-span-3 `}>
            ...
            <p className="text-[16px] md:text-[18px] lg:text-[24px] text-[#5D5D5D]">
              <Trans ns="UmrahFamily" i18nKey="visitsDes" />
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center flex justify-center">
        <div className="text-[16px] md:text-[20px] lg:text-[24px] w-full md:w-[600px] lg:w-[859px] text-[#5D5D5D] mb-[100px] mx-auto">
          <Trans ns="UmrahFamily" i18nKey="ourFamily" />
        </div>
      </div>
