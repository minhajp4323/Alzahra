...
function Welcome({ onClose }) {
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-start gap-6  sm:gap-12 px-4 sm:px-10 text-[20px]">
        <div className="text-center sm:text-left mr-16">
        ...
        <div className="text-center sm:text-left">
          ...
          {/* <div
            onClick={onClose}
            className="border-2 border-black rounded-[20px] w-full sm:w-[309px] h-[65px] flex items-center justify-center mt-2 text-[20px]"
          >
            عربي
          </div> */}
        </div>
